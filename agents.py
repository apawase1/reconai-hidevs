...
reporting_agent = LlmAgent(
    ...
    instruction=(
        ...
        "income_breakdown, subscriptions, recurring_investments, "
        "payments_pending, duplicate/missing/recurring counts, "
        "gst_eligible_total, and a markdown summary. "
        ...
        "side); "
        "4) Money in this period — if `total_income` is non-zero, list "
        ...
        "part of it; skip this section entirely if total_income is 0; "
        "5) Payments pending — list from `payments_pending` if non-empty "
        ...
        "action); "
        "6) 2-4 concrete recommendations based on what the report flagged "
